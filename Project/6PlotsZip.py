...
"""Creating our argparser which will take in command line arguments. There are 2 mandatory arguments: the filepath of the zip file you wish to unpack
...
parser = argparse.ArgumentParser(description='Enter a filepath for a zipfile')
"""Adding arguments"""
parser.add_argument(
    'zipfilepath',
...
def read_zip_file(filepath):
    """
    Function for unzipping the zipfile
    """
...
#Unzipping the file and saving the returned var in a variable called observationFilepaths
observationFilepaths = read_zip_file(args.zipfilepath)

#Getting the titles of each file in the zip and logging them into blimpy.waterfall
...
#Finding the timestamps and freqstamps for each
